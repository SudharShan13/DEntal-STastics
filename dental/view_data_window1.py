...
class view_data_window:
    ...
    def print_excel(self):
            ...
            if(self.ETable_Name_Drop.get()=="Department" and self.EPatient_Type_Drop.get()=="Reffered"):
            ...
            if(self.ETable_Name_Drop.get()=="Dental Camp" and self.EPatient_Type_Drop.get()=="Reffered"):
            ...
            if(self.ETable_Name_Drop.get()=="Turnover" and self.EPatient_Type_Drop.get()=="Reffered"):
            ...
            if(self.ETable_Name_Drop.get()=="Satellite" and self.EPatient_Type_Drop.get()=="Reffered"):
